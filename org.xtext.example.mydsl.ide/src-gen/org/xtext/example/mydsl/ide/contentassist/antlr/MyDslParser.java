		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRImportSyntaxAccess().getGroup(), "rule__RImportSyntax__Group__0");
					put(grammarAccess.getRImportSemanticAccess().getGroup(), "rule__RImportSemantic__Group__0");
					put(grammarAccess.getRImportServiceAccess().getGroup(), "rule__RImportService__Group__0");
					...
					put(grammarAccess.getRRootAccess().getBehaviourAssignment_1(), "rule__RRoot__BehaviourAssignment_1");
					put(grammarAccess.getRRootAccess().getSyntaxesAssignment_2(), "rule__RRoot__SyntaxesAssignment_2");
					...
					put(grammarAccess.getRClassAccess().getOperationsAssignment_6(), "rule__RClass__OperationsAssignment_6");
