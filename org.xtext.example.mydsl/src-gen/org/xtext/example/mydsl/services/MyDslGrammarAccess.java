...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RRootElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cBehaviourAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cBehaviourQualifiedParserRuleCall_1_0 = (RuleCall)cBehaviourAssignment_1.eContents().get(0);
		private final Assignment cSyntaxesAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cSyntaxesRImportSyntaxParserRuleCall_2_0 = (RuleCall)cSyntaxesAssignment_2.eContents().get(0);
		private final Assignment cSemanticsAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cSemanticsRImportSemanticParserRuleCall_3_0 = (RuleCall)cSemanticsAssignment_3.eContents().get(0);
		private final Assignment cServicesAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cServicesRImportServiceParserRuleCall_4_0 = (RuleCall)cServicesAssignment_4.eContents().get(0);
		...
		//'behavior' behaviour=Qualified syntaxes+=rImportSyntax* semantics+=rImportSemantic* services+=rImportService*
		//xtendedClasses+=rClass*
		...
		//behaviour=Qualified
		public Assignment getBehaviourAssignment_1() { return cBehaviourAssignment_1; }
		
		//Qualified
		public RuleCall getBehaviourQualifiedParserRuleCall_1_0() { return cBehaviourQualifiedParserRuleCall_1_0; }
		
		//syntaxes+=rImportSyntax*
		public Assignment getSyntaxesAssignment_2() { return cSyntaxesAssignment_2; }
		
		//rImportSyntax
		public RuleCall getSyntaxesRImportSyntaxParserRuleCall_2_0() { return cSyntaxesRImportSyntaxParserRuleCall_2_0; }
		
		//semantics+=rImportSemantic*
		public Assignment getSemanticsAssignment_3() { return cSemanticsAssignment_3; }
		
		//rImportSemantic
		public RuleCall getSemanticsRImportSemanticParserRuleCall_3_0() { return cSemanticsRImportSemanticParserRuleCall_3_0; }
		
		//services+=rImportService*
		public Assignment getServicesAssignment_4() { return cServicesAssignment_4; }
		
		//rImportService
		public RuleCall getServicesRImportServiceParserRuleCall_4_0() { return cServicesRImportServiceParserRuleCall_4_0; }
	...
	public class QualifiedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Qualified");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RImportSyntaxElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.rImportSyntax");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cImportSyntaxAction_0 = (Action)cGroup.eContents().get(0);
		...
		//rImportSyntax ImportSyntax:
		//	{ImportSyntax}
		//	'import' 'syntax' uri=STRING 'as' name=ID ';'
		@Override public ParserRule getRule() { return rule; }
		
		//{ImportSyntax} 'import' 'syntax' uri=STRING 'as' name=ID ';'
		public Group getGroup() { return cGroup; }
		
		//{ImportSyntax}
		public Action getImportSyntaxAction_0() { return cImportSyntaxAction_0; }
	...
	public class RImportSemanticElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.rImportSemantic");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cImportKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cSemanticKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final RuleCall cQualifiedParserRuleCall_2 = (RuleCall)cGroup.eContents().get(2);
		...
		//rImportSemantic:
		//	'import' 'semantic' Qualified 'as' ID '(' ID '=>' ID ')' ';';
		@Override public ParserRule getRule() { return rule; }
		...
		//Qualified
		public RuleCall getQualifiedParserRuleCall_2() { return cQualifiedParserRuleCall_2; }
	...
	public class RImportServiceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.rImportService");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cImportKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class RClassElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cSyntaxImportSyntaxCrossReference_1_0 = (CrossReference)cSyntaxAssignment_1.eContents().get(0);
		private final RuleCall cSyntaxImportSyntaxIDTerminalRuleCall_1_0_1 = (RuleCall)cSyntaxImportSyntaxCrossReference_1_0.eContents().get(1);
		...
		//rClass:
		//	'class' syntax=[ImportSyntax] '.' name=ID '{' attributes+=rAttribute* operations+=rOperation* '}';
		@Override public ParserRule getRule() { return rule; }
		...
		//[ImportSyntax]
		public CrossReference getSyntaxImportSyntaxCrossReference_1_0() { return cSyntaxImportSyntaxCrossReference_1_0; }
		
		//ID
		public RuleCall getSyntaxImportSyntaxIDTerminalRuleCall_1_0_1() { return cSyntaxImportSyntaxIDTerminalRuleCall_1_0_1; }
	...
	public class NonLeftRecExpressionElements extends AbstractParserRuleElementFinder {
		...
		//'not' expression | '-' expression | ID | literal | '(' expression ')' | 'if' expression 'then' expression 'else'
	...
	public class CallExpElements extends AbstractParserRuleElementFinder {
		...
		//collectionIterator '(' variableDefinition lambdaExpression ')' | ID '(' expressionSequence ')'
		public Alternatives getAlternatives() { return cAlternatives; }
	...
	public class LiteralElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cIDTerminalRuleCall_8_0 = (RuleCall)cGroup_8.eContents().get(0);
		private final Keyword cColonColonKeyword_8_1 = (Keyword)cGroup_8.eContents().get(1);
		private final RuleCall cIDTerminalRuleCall_8_2 = (RuleCall)cGroup_8.eContents().get(2);
		private final Keyword cColonColonKeyword_8_3 = (Keyword)cGroup_8.eContents().get(3);
		private final RuleCall cIDTerminalRuleCall_8_4 = (RuleCall)cGroup_8.eContents().get(4);
		private final Group cGroup_9 = (Group)cAlternatives.eContents().get(9);
		private final RuleCall cIDTerminalRuleCall_9_0 = (RuleCall)cGroup_9.eContents().get(0);
		private final Keyword cColonColonKeyword_9_1 = (Keyword)cGroup_9.eContents().get(1);
		private final RuleCall cIDTerminalRuleCall_9_2 = (RuleCall)cGroup_9.eContents().get(2);
		...
		//ID
		public RuleCall getIDTerminalRuleCall_8_2() { return cIDTerminalRuleCall_8_2; }
		
		//'::'
		public Keyword getColonColonKeyword_8_3() { return cColonColonKeyword_8_3; }
		
		//ID
		public RuleCall getIDTerminalRuleCall_8_4() { return cIDTerminalRuleCall_8_4; }
		
		//ID '::' ID ':'
		public Group getGroup_9() { return cGroup_9; }
		
		//ID
		public RuleCall getIDTerminalRuleCall_9_0() { return cIDTerminalRuleCall_9_0; }
		
		//'::'
		public Keyword getColonColonKeyword_9_1() { return cColonColonKeyword_9_1; }
		
		//ID
		public RuleCall getIDTerminalRuleCall_9_2() { return cIDTerminalRuleCall_9_2; }
	...
	private final RImportSyntaxElements pRImportSyntax;
	private final RImportSemanticElements pRImportSemantic;
	private final RImportServiceElements pRImportService;
	...
	public MyDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pRImportSyntax = new RImportSyntaxElements();
		this.pRImportSemantic = new RImportSemanticElements();
		this.pRImportService = new RImportServiceElements();
	...
	//	{ImportSyntax}
	//	'import' 'syntax' uri=STRING 'as' name=ID ';'
	public RImportSyntaxElements getRImportSyntaxAccess() {
		return pRImportSyntax;
	}
	
	public ParserRule getRImportSyntaxRule() {
		return getRImportSyntaxAccess().getRule();
	}
	
	//rImportSemantic:
	//	'import' 'semantic' Qualified 'as' ID '(' ID '=>' ID ')' ';';
	public RImportSemanticElements getRImportSemanticAccess() {
		return pRImportSemantic;
	}
	
	public ParserRule getRImportSemanticRule() {
		return getRImportSemanticAccess().getRule();
	}
	
	//rImportService:
	//	'import' 'service' Qualified ';';
	public RImportServiceElements getRImportServiceAccess() {
		return pRImportService;
	}
	
	public ParserRule getRImportServiceRule() {
		return getRImportServiceAccess().getRule();
	}
