...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  public EAttribute getrRoot_Behaviour()
  {
   ...
   * @generated
   */
  public EReference getrRoot_Syntaxes()
  {
   ...
   * @generated
   */
  public EAttribute getrRoot_Semantics()
  {
    return (EAttribute)rRootEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getrRoot_Services()
  {
    return (EAttribute)rRootEClass.getEStructuralFeatures().get(3);
  }
  ...
  {
    return (EReference)rRootEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getrClass_Syntax()
  {
    return (EReference)rClassEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(rRootEClass, RROOT__BEHAVIOUR);
    createEReference(rRootEClass, RROOT__SYNTAXES);
    createEAttribute(rRootEClass, RROOT__SEMANTICS);
